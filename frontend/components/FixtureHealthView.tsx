    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md text-xs font-medium bg-[#101010] hover:bg-[#141B26] text-[#8B949E] hover:text-white transition-all self-start md:self-auto"
        >
      ...
      {showFormulaInfo && (
        <div className="bg-[#101010] rounded-md p-5 shadow-lg space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 text-xs">
            <div className="p-2.5 rounded-md bg-[#080808]">
      ...
      <div className="bg-[#101010] rounded-md p-4 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
        {/* Zone Filters */}
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <select
            ...
            className="bg-[#080808] text-xs text-[#F0F6FC] px-2.5 py-1.5 rounded-lg border border-white/[0.08] focus:outline-none focus:border-[#4D88C7]/50"
          >
        ...
        {filteredRecords.map((fixture) => {
          ...
          return (
            <div
              ...
              className="group bg-[#101010] hover:bg-[#141B26] rounded-md p-5 shadow-sm transition-all duration-200 cursor-pointer flex flex-col justify-between"
            >
              {/* Card Top */}
              <div>
                ...
                <div className="mt-3 flex items-center justify-between text-xs text-[#8B949E] bg-[#080808] p-2.5 rounded-lg border border-white/[0.04]">
      ...
      {selectedFixture && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
            <div className="w-screen max-w-lg bg-[#101010] border-l border-white/10 shadow-2xl flex flex-col">
              {/* Drawer Header */}
              <div className="px-6 py-5 border-b border-white/[0.08] bg-[#080808] flex items-center justify-between">
                <div>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="bg-[#080808] rounded-md p-5 space-y-3">
                  <div className="flex items-center justify-between">
                    <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div
                        key={idx}
                        className="bg-[#080808] border border-white/[0.06] rounded-lg p-3 space-y-1.5"
                      >
                        <div className="flex items-center justify-between text-xs">
                ...
                <div className="space-y-3 pt-2">
                  ...
                  {selectedFixture.anomaly_count === 0 ? (
                    <div className="p-4 rounded-md bg-[#080808] text-center text-xs text-[#8B949E]">
                      No anomalous tickets recorded. Fixture telemetry is stable.
                    </div>
                  ) : (
                    <div className="space-y-2">
                      <div className="p-3 rounded-lg bg-[#080808] border border-white/[0.06] text-xs space-y-1">
                        <div className="flex items-center justify-between">
